...
function paramsToHref(to) {
  ...
  var pathParams = Object.keys(params)
      .reduce(function (acc, key) {
      acc[key] = params[key];
      return acc;
  }, {});
  var pathWithParams = path.replace(/\:(\w+)/g, function (_, key) {
...
function checkExternalLink(to) {
  if (typeof to === 'string' && to.startsWith('http')) {
      ...
      var path = typeof to.params === 'object' ? paramsToHref(to) : to.path;
      var queryString = typeof to.query === 'object' ? queryToString(to.query) : '';
...
var Link = {
  ...
  render: function render (h) {
    ...
    var this$1 = this;
    var ref = checkExternalLink(this$1.to);
    var isExternalLink = ref.isExternalLink;
    var _href = ref._href;
    var isJavascript = ref.isJavascript;
    ...
    var ref$1 = router.resolve(
      this.to,
      current,
      this.append
    );
    var location = ref$1.location;
